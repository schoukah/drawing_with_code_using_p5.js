...
function draw() {
  ...
  circleHeightOld = circleWidth;
  circleXOld = circleWidthOld/2 + random(400-circleWidthOld);
  circleYOld = circleHeightOld/2 + random(400-circleHeightOld);
  circleWidthNew = random(200);
  circleHeightNew = circleWidthNew;
  circleXNew = circleWidthNew/2 + random(400-circleWidthNew);
  circleYNew = circleHeightNew/2 + random(400-circleHeightNew);
  fill(colours[0]);
