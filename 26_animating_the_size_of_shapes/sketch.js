...
function draw() {
  ...
  circleWidthStart += (circleWidthStop - circleWidthStart)/10;
  circleHeightStart = circleWidthStart;
  if (circleXStop - circleXStart < 1 && circleYStop - circleYStart < 1 && circleWidthStop - circleWidthStart < 1) {
    circleIsDone = true;
  }
  ...
  squareWidthStart += (squareWidthStop - squareWidthStart)/10;
  squareHeightStart = squareWidthStart;
  if (squareXStop - squareXStart < 1 && squareYStop - squareYStart < 11 && circleWidthStop - circleWidthStart < 1) {
    squareIsDone = true;
  }
